...
declare type SubtableLayoutForParameter = {
    type: "SUBTABLE";
    code: string;
    fields: Array<{
        [key: string]: unknown;
...
declare type GroupLayoutForParameter = {
    type: "GROUP";
    code: string;
    layout: RowLayoutForParameter[];
};
declare type LayoutForParameter = Array<RowLayoutForParameter | SubtableLayoutForParameter | GroupLayoutForParameter>;
declare type NestedPartial<T> = T extends object ? {
    [K in keyof T]?: NestedPartial<T[K]>;
} : T;
declare type PropertiesForParameter = NestedPartial<Properties>;
